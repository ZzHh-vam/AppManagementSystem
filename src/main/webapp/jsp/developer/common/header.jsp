			...
			<div class="col-md-3 left_col menu_fixed">
				<div class="left_col scroll-view">
					<div class="navbar nav_title" style="border: 0;">
						<a href="${pageContext.request.contextPath }/index.jsp" class="site_title"><i class="fa fa-paw"></i> <span>APP
								BMS</span>
						</a>
					</div>
						...
						<div class="menu_section">
							...
							<ul class="nav side-menu">
								...
								<li>
									...
									<ul class="nav child_menu">
										<li><a href="${pageContext.request.contextPath}/allAppInfo">APP维护</a>
										</li>
									</ul>
								</li>
							</ul>
						...
						<ul class="nav navbar-nav navbar-right">
							<li class=""><a href="javascript:;"
								...
								aria-expanded="false"> <img
									src="${pageContext.request.contextPath }/statics/images/img.jpg"
									alt="">${loginInfo.devcode} <span
									class=" fa fa-angle-down"></span> </a>
								<ul class="dropdown-menu dropdown-usermenu pull-right">
									<li><a
										href="${pageContext.request.contextPath}/loginOut"><i
