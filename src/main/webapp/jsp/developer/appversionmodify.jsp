...
<div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      <div class="x_title">
        <h2>修改APP最新版本信息 <i class="fa fa-user"></i>${loginInfo.devcode}</h2>
            <div class="clearfix"></div>
      </div>
      <div class="x_title">
            <h2>历史版本列表</h2>
	  ...
	  <p class="text-muted font-13 m-b-30"></p>
			...
			<div class="row">
				<div class="col-sm-12">
					<table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap dataTable no-footer dtr-inline collapsed"
						...
						<tbody>
							<c:forEach var="appVersion" items="${list}" varStatus="status">
        ...
        <div class="x_content" style="display: block;">
         <br>
        <form class="form-horizontal form-label-left" action="${pageContext.request.contextPath}/updateVersion" method="post" enctype="multipart/form-data">
           <input type="hidden" name="id" id="id" value="${appVersion.id}">
            <input type="hidden" name="oldPicPath" id="oldPicPath" value="${appVersion.downloadlink}" />
          ...
          <div class="item form-group">
           ...
           <div class="item form-group">
			...
			<div id="uploadfile">
				<input id="attach" type="file" class="form-control col-md-7 col-xs-12" name="attach">${appVersion.apkfilename}
            ...
            <input type="hidden" name="modifydate" value="<fmt:formatDate value="${now}" pattern="yyyy-MM-dd HH:mm:ss"/>" >
            <input type="hidden" name="creationdate" value="<fmt:formatDate value="${now}" pattern="yyyy-MM-dd HH:mm:ss"/>" />
