...
<div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      <div class="x_title">
        <h2>新增APP基础信息 <i class="fa fa-user"></i>${loginInfo.devcode}</h2>
             <div class="clearfix"></div>
      </div>
      <div class="x_content">
	  <!-- <div class="item form-group">
           ...
           <div class="clearfix"></div>
        <form class="form-horizontal form-label-left" action="${pageContext.request.contextPath}/addAppInfo" method="post" enctype="multipart/form-data">
          <div class="item form-group">
...
<script language="JavaScript" type="text/javascript">
    ...
    $(function(){
        //1.加载平台
        //$.post("/getAppPt",null,function(data){
        //pageContext.request.contextPath相当于这个目录http://localhost:8080/
        ...
        function loadCategroyLevel2(){
            ...
            $("#categoryLevel2>option:gt(0)").remove();  //清空现有项
        ...
        //二级联动效果
        $("#categoryLevel1").change(loadCategroyLevel2);

        //4.加载三级分类
        function loadLevel3(){
            //获取当前下拉列表中选中项的值
            var parentId=$("#categoryLevel2").val();
            $("#categoryLevel3>option:gt(0)").remove();  //清空现有项
            if(parentId!=""){  //为"" 表示选中了“请选择”
                //发送异步请求加载
                $.post("${pageContext.request.contextPath }/getCategroyByParentId",{"id":parentId},function(data){
                    //获取数据动态添加到下拉列表
        ...
        //联动效果
        $("#categoryLevel2").change(loadLevel3);
    });
</script>