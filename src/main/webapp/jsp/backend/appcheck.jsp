...
<div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      <div class="x_title">
        <h2>查看并审核APP信息 <i class="fa fa-user">${loginInfo.username}</i></h2>
             <div class="clearfix"></div>
      </div>
      <div class="x_title">
            <h2>APP基础信息</h2>
      ...
      <div class="x_content1">
        <form class="form-horizontal form-label-left" action="${pageContext.request.contextPath}/auditingStatus" method="post">
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input type="text" class="form-control col-md-7 col-xs-12" 
              	value="${appInfo.cname1} --> ${appInfo.cname2} --> ${appInfo.cname3}" readonly="readonly">
            </div>
          </div>
          <div class="item form-group">
           ...
           <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
			 <c:choose>
                 ...
                 <c:otherwise>
                   <img src="${logopicpath}" width="100px;"/>
                 </c:otherwise>
              </c:choose> 
            </div>
          </div>
        	<div class="form-group">
        		...
        		<button id="status1" type="button" name="status" value="2" class="btn btn-success" onclick="javascript:if (confirm('是否通过?')){window.location.href = '${pageContext.request.contextPath}/auditingStatus?id=${appInfo.id}&status=2';}">审核通过</button>
        		<button id="status2" type="button" name="status" value="3" class="btn btn-success" onclick="javascript:if (confirm('是否不通过?')){window.location.href = '${pageContext.request.contextPath}/auditingStatus?id=${appInfo.id}&status=3';}">审核不通过</button>
